...
export default function reducer(orgState = initialState, action = {}) {
  ...
  switch (action.type) {
    ...
    case actions.DATA_ITEM_UPDATE_SUCCESS:
    ...
    case actions.DATA_ITEM_UPDATE_FAIL:
    ...
    case actions.DATA_ITEM_CREATE_FAIL:
