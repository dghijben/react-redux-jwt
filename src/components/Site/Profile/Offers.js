...
import {fetchDataDeferred3} from './fetchDataDeferred';
let myTimeout = null;

@connectData(null, fetchDataDeferred3)
@connectToFilter()
@connect(state=> {
  const obj = {
    'router': state.router,
      ...
      <div ref="main">
        ...
        <div className="row pos-relative">
          <div className="col-md-9 col-md-push-3 ">
            <Pending state={_.get(this.props, ['aanbiedingen', 'pending'], true)} failed={_.get(this.props, ['aanbiedingen', 'failed'], true)}>
              <List
