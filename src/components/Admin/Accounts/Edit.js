...
import fields, {path, title, reducerIndex, reducerKey, reducerKeyUsers, reducerKeyCats, reducerItem, initialValues, fetchDataDeferred} from './fields';
            ...
            <Row>
              ...
              <Col md={10}>
                <DynamicForm
                  ...
                  fieldsNeeded={fields(_.get(item, ['id']), this.props.token, this.showResource, _.get(item, 'users', []), _.get(this.props, 'data.accountCategories.all', []))}
