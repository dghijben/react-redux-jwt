...
import {load, destroyItem} from 'redux/modules/admin/affiliates/categories/actions';
        ...
        <div id="content">
          <Well>
            <DataOverview
              ...
              cols={[
                {name: 'Categorie', show: 'name'},
                {name: 'Actief', show: 'active', translate: {false: 'Nee', true: ' Ja'}},
